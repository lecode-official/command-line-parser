...
namespace System.CommandLine.ValueConverters
{
    ...
    public class IntegerConverter : IValueConverter
    {
        ...
        public object Convert(Type type, string value)
        {
            ...
            {
                if (type == typeof(byte))
                    return byte.Parse(value, NumberStyles.Number, CultureInfo.InvariantCulture);
                if (type == typeof(sbyte))
                    return sbyte.Parse(value, NumberStyles.Number, CultureInfo.InvariantCulture);
                if (type == typeof(short))
                    return short.Parse(value, NumberStyles.Number, CultureInfo.InvariantCulture);
                if (type == typeof(ushort))
                    return ushort.Parse(value, NumberStyles.Number, CultureInfo.InvariantCulture);
                if (type == typeof(int))
                ...
                if (type == typeof(long))
                    return long.Parse(value, NumberStyles.Number, CultureInfo.InvariantCulture);
                if (type == typeof(ulong))
                    return ulong.Parse(value, NumberStyles.Number, CultureInfo.InvariantCulture);
            }
