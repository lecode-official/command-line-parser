...
namespace System.CommandLine.Parser.UnitTests
{
    ...
    public class AntlrParserUnitTests
    {
        ...
        private IParseTree ParseTokens(CommandLineLexer lexer, out Antlr.CommandLineParser parser)
        {
            // Parses the token stream
            parser = new Antlr.CommandLineParser(new CommonTokenStream(lexer))
            {
                BuildParseTree = true
            };
        ...
        private void ValidateParseTree(Antlr.CommandLineParser parser, IParseTree parseTree, TreeNode expectedParseTree)
        {
